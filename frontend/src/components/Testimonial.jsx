      ...
      <div className={styles.innerContainer}>
        ...
        <div className={styles.headerContainer}>
          ...
          <h1 className={styles.title}>
            Premium <span className={styles.accentText}>Driver</span>Experience
          </h1>
        ...
        <div className={styles.statsContainer}>
          <div className={styles.statsGrid}>
            ...
            <div className={styles.statItem}>
              <div
                className={`${styles.statValue} ${styles.statColors.value[0]}`}
              >
                10k+
              </div>
              <div
                className={`${styles.statLabel} ${styles.statColors.label[0]}`}
              >
                Happy Customers
              </div>
            </div>
            ...
            <div className={styles.statItem}>
              <div
                className={`${styles.statValue} ${styles.statColors.value[1]}`}
              >
                250+
              </div>
              <div
                className={`${styles.statLabel} ${styles.statColors.label[1]}`}
              >
                Luxury Vehicles
              </div>
            </div>
            ...
            <div className={styles.statItem}>
              <div
                className={`${styles.statValue} ${styles.statColors.value[2]}`}
              >
                24/7
              </div>
              <div
                className={`${styles.statLabel} ${styles.statColors.label[2]}`}
              >
                Support
              </div>
            </div>
            ...
            <div className={styles.statItem}>
              <div
                className={`${styles.statValue} ${styles.statColors.value[3]}`}
              >
                50+
              </div>
              <div
                className={`${styles.statLabel} ${styles.statColors.label[3]}`}
              >
                Locations
              </div>
            </div>
