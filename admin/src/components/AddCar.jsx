...
const AddCar = () => {
  ...
  const renderInputField = (field) => (
    <div key={field.name} className={AddCarPageStyles.inputContainer}>
      <label
        className={
      ...
      >
        {field.icon && (
          <span className={AddCarPageStyles.icon}>{field.icon}</span>
        )}
        {field.name}
      </label>
  ...
  const leftColumnFields = [
    ...
    },
    {
      ...
      config: {
        ...
        prefix: <span className="absolute left-3 top-3 text-gray-400">Rs</span>,
      },
    },
    {
      type: "select",
                  ...
                  return (
                    <div key={field.config.name}>
                      ...
                      <div className="relative">
                        {field.config.prefix && (
                          <span className={AddCarPageStyles.prefix}>
                            {field.config.prefix}
                          </span>
                        )}
                        <input
