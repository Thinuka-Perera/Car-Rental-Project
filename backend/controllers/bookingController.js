...
// Build a summary object of the car
...
export const createBooking = async (req, res) => {
  ...
  try {
    ...
    // Create booking and update car record
...
//GET Booking for a particuler User
...
export const getMyBookings = async (req, res, next) => {
  try {
    ...
    const bookings = await Booking.find({ userId })
      .sort({ pickupDate: -1 }) // sort by pickup date (you can change this)
      .lean();
